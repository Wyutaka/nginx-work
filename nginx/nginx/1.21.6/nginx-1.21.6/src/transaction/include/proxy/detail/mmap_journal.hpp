//
// Created by miwa on 2020/12/30.
//

#ifndef TRANSACTION_MMAP_JOURNAL_HPP
#define TRANSACTION_MMAP_JOURNAL_HPP
...
namespace proxy {
    namespace transaction {
        ...
        namespace journal {
            ...
            public:
                void append(const cpp17::string_view &str) {
                ...
                std::vector<cpp17::string_view> sync() const {
                    auto first =
                        reinterpret_cast<const char *>(std::get<MmapPool::kPointerIndex>(area_));

                    std::vector<cpp17::string_view> contents;
...
#endif // TRANSACTION_MMAP_JOURNAL_HPP
